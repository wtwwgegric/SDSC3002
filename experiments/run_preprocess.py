...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Preprocess MovieLens ratings into an item-user matrix.")
...
def main() -> None:
    ...
    with timer() as timing:
        ...
        matrix, metadata = build_item_user_matrix(ratings, min_rating=args.min_rating)
